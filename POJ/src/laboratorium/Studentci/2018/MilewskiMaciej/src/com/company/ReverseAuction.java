...
public class ReverseAuction implements Auction
{
    ...
    public ReverseAuction(String name, String description, double price, int round, int minimal_trust)
    {
        this.name = name;
    ...
    public ReverseAuction(Auctioneer auctioneer, String name, String description, double price, int round, int minimal_trust)
    {
    ...
    public void auctionResult()
    {
        ...
        System.out.println("");
        System.out.println("Dostępne środki użytkowników:");
        for (Observer b : this.getBidders())
        {
            System.out.println(b.getName() + ":   " + b.getBudget() + " PLN");
        }
        System.out.println("");
    }
            ...
            if (command.equals("next"))
            {
                ...
                for (Observer b : this.getBidders())
                {
                    ...
                    else
                    {
                        ...
                        b.setBudget(b.getBudget()-1);
                        // Pytanie do użytkownika
                        System.out.println("    Czy akceptujesz cene: " + (bid-1) + " T/N");
                        System.out.print("    ");
                        decision = nextRoundToken.next();
