package _0C_Testy.romanNum.stage1;
...
public class RomanTest {
	...
	public void testToRomanBadInputTooLarge() {
		Roman.toRoman(4000);
	}

	// toRoman should fail with 0 input
	@Test(expected = OutOfRangeException.class)
	public void testToRomanBadInputZero() {
		Roman.toRoman(0);
	}

	// toRoman should fail with negative input
	@Test(expected = OutOfRangeException.class)
	public void testToRomanNegative() {
		Roman.toRoman(-1);
	}

	// fromRoman should fail with too many repeated numerals
	@Test(expected = OutOfRangeException.class)
	public void testFromRomanBadInputTooManyRepeatedNumerals() {
	...
	public void testFromRomanBadInputRepeatedPairs() {
	...
	@Test(expected = InvalidRomanNumeralException.class)
	public void testFromRomanBadInputMalformedAntecedent() {
